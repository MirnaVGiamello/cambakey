...
<div style="max-width:400px">
  <a href="<?= site_url('admin/tipos-producto') ?>" class="btn btn-sm btn-outline-secondary mb-3"><i class="bi bi-arrow-left me-1"></i>Volver</a>
  <div class="card shadow-sm border-0">
    <div class="card-body">
      <form method="post" action="<?= $esNuevo ? site_url('admin/tipos-producto/guardar') : site_url('admin/tipos-producto/actualizar/' . $tipo['id']) ?>">
        <?= csrf_field() ?>
        <div class="mb-3">
